...
//     public AccountService(UsersContext usersContext)
//     {
//         db=usersContext;
...
//         // [HandleError]
//         public string Login(LoginModel model, string returnUrl)
//         {
...
//         {
//             var identity = new SelectList(new[] { "Admin", "User","Guest"});
...
//             ViewBag.companies = new SelectList(companies ?? new List<string>());
//             return PartialView();
//         }
