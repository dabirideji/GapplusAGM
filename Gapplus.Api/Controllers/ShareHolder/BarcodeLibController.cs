...
// {
//     [Authorize]
//     public class BarcodeLibController : Controller
//     {
//         UsersContext db;
//         public BarcodeLibController(UsersContext _db, UserAdmin _ua, AGMManager _agm)
//         {
//             db = _db;
//             ua = _ua;
//             agmM = _agm;
...
//                 model2.Message = "COULDNOT VERIFY SHAREHOLDER";
...
//         [HttpPost]
//         public ActionResult Create(BarcodeModelView model)
//         {
//             try
//             {
