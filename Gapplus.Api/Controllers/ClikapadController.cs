...
namespace BarcodeGenerator.Controllers
{
    ...
    public class ClikapadController : ControllerBase
    {
        UsersContext db;
        Stopwatch stopwatch = new Stopwatch();
        UserAdmin ua;

        public ClikapadController(UsersContext context)
        ...
        //    return AGMID;
        //}
        private async Task<bool> GetClikapadResult(string company)
        {
        ...
        private Task<bool> GetClikapadResultsAsync(string company)
        {
            try
            {
                //var companyinfo = ua.GetUserCompanyInfo();
        ...
        private void ClearKeyPadResults(string company)
        {
            //var companyinfo = ua.GetUserCompanyInfo();
            var UniqueAGMId = ua.RetrieveAGMUniqueID(company);
