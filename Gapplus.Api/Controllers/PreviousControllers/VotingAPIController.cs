...
namespace BarcodeGenerator.Controllers
{
    ...
    public class VotingAPIController : ControllerBase
    {
       ...
       private readonly IViewBagManager _viewBagManager;
        public VotingAPIController(UsersContext _db,ITempDataManager tempDataManager,IViewBagManager viewBagManager)
        {
            db=_db;
        ...
        public async Task<ActionResult> AbstainButtonChoice(string company)
        {
