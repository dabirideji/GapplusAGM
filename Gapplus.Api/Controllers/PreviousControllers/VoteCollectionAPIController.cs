...
namespace BarcodeGenerator.Controllers
{
    ...
    public class VoteCollectionAPIController : ControllerBase
    {
       ...
       private readonly IViewBagManager _viewBagManager;
        public VoteCollectionAPIController(UsersContext _db,ITempDataManager tempDataManager,IViewBagManager viewBagManager)
        {
            db=_db;
