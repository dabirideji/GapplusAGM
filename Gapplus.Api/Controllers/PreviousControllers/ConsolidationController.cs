...
//         public Task<List<BarcodeModel>> ConsolidateIndexAsync(string val)
//         {
//             var companyinfo = ua.GetUserCompanyInfo();
//             try
//             {
...
//         public void CloseConsolidationSlide()
//         {
//             var companyinfo = ua.GetUserCompanyInfo();
//             try
//             {
...
//         public Task<BarcodeModel> SearchRequestAsync(SearchModel post)
//         {
//             try
//             {
...
//         public Task<BarcodeModel> ConsolidateRequestAsync(string val)
//         {
//             try
//             {
//                 var companyinfo = ua.GetUserCompanyInfo();
...
//         public Task<string> RegularizeNameAsync(string val, string name)
//         {
//             try
//             {
//                 var companyinfo = ua.GetUserCompanyInfo();
...
//         public Task<string> RegularizePhoneNumberAsync(string val, string phonenumber)
//         {
//             try
//             {
//                 var companyinfo = ua.GetUserCompanyInfo();
...
//         public Task<string>RegularizeEmailAsync(string val, string email)
//         {
//             try
//             {
//                 var companyinfo = ua.GetUserCompanyInfo();
...
//         public async Task<string> UnConsolidate(PostSelectModel post)
//         {
...
//         public Task<string> UnConsolidateAsync(string val)
//         {
//             try
//             {
//                 var companyinfo = ua.GetUserCompanyInfo();
